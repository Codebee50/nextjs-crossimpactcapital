...
const TeamSection = () => {
    ...
    return (
        <div className='w-full min-h-dvh padding-x section-con'>
            <div className='w-full flex flex-col items-center justify-center'>
                <h1 className='text-3xl capitalize font-semibold'>Meet the team</h1>
            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-2  gap-20 mt-[90px] items-center overflow-x-scroll no-scrollbar'>
