...
const EthosSection = () => {
    ...
    return (
        <div className='section-con pt-[50px]'>
            <div className='flex flex-col gap-2 items-center justify-center'>
                <h1 className="
                    ...
                    Aligned Values, <br /> Measurable Impact</h1>
            ...
            <div className='flex flex-row items-center justify-center gap-5 mt-20'>
                {
                    ethos.map((ethos) => (
                        <div key={ethos.title} className='relative h-[550px] group overflow-hidden'>
                            ...
                            <div className='flex flex-col gap-2 h-full justify-between p-8 cursor-pointer absolute inset-0 z-10'>
                                ...
                                <div className='flex flex-col gap-6'>
                                    ...
                                    <Link
                                        href="/apply"
                                        className='flex flex-row items-center gap-2 font-medium text-black group-hover:text-white transition-colors duration-500'
                                    >
